...
// 첨부 개수. 배열(폼에서 온 attachments) 또는 attachmentsJson 문자열(DB값) 모두 허용.
// 검수요청(review)에는 폐기 사진이 1장 이상 필요한 게이트에서 쓴다(매니저가 사진 보고 승인).
export function attachmentCount(value) {
