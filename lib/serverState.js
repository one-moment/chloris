...
export function createMessageRecord({ body, author = "captain", bot = false, attachments = [] }) {
  return {
...
export function createPostRecord({ title, body, author = "captain", status = "검토중", attachments = [] }) {
  return {
