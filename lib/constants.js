...
export const CHANNEL_TYPES = {
  ...
  improvement: {
    label: "개선 건의",
    tone: "neutral",
    description: "직원 개선 요청을 게시판으로 접수하고 검토, 개발중, 완료됨 상태로 추적합니다."
  }
};
...
export const IMPROVEMENT_POST_STATUSES = ["검토", "개발중", "완료됨"];

export const ALL_POST_STATUSES = [...POST_STATUSES, ...IMPROVEMENT_POST_STATUSES];

export function getPostStatuses(channel) {
  return channel?.type === "improvement" ? IMPROVEMENT_POST_STATUSES : POST_STATUSES;
}
